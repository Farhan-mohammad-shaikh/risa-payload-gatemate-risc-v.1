...
{
    auto* barrier = new unittest::rtos::BarrierImplementation(this, numberOfThreads);
    mImplementation = barrier;
}

outpost::rtos::Barrier::~Barrier()
{
    auto* barrier = reinterpret_cast<unittest::rtos::BarrierImplementation*>(mImplementation);
    delete barrier;
