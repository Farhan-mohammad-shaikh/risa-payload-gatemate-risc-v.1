 ...
 * regular C++
 */
#ifndef OUTPOST_STORAGE_INT_H_
#define OUTPOST_STORAGE_INT_H_
...
public:
    ...
    Integer(int32_t data)
    {
        ...
        const uint8_t* sourcePointer = reinterpret_cast<uint8_t*>(&data);
        if (isBigEndian())
        {
...
using uint24_t = storage::UInteger<24>;
using int24_t = storage::Integer<24>;
using uint48_t = storage::UInteger<48>;
using int48_t = storage::Integer<48>;
...
template <size_t bits>
class numeric_limits<outpost::storage::UInteger<bits>>
{
public:
    static constexpr bool is_specialized = true;

    static constexpr typename outpost::storage::UInteger<bits>::PrimitiveType
    min() noexcept
    {
        return outpost::storage::UInteger<bits>::minValue;
    }

    static constexpr typename outpost::storage::UInteger<bits>::PrimitiveType
    max() noexcept
    {
        return outpost::storage::UInteger<bits>::maxValue;
    }
...
// PrimitiveType used as return as the constructor cannot be constexpr in C++11.
template <size_t bits>
class numeric_limits<outpost::storage::Integer<bits>>
{
public:
    static constexpr bool is_specialized = true;

    static constexpr typename outpost::storage::Integer<bits>::PrimitiveType
    min() noexcept
    {
        return outpost::storage::Integer<bits>::minValue;
    }

    static constexpr typename outpost::storage::Integer<bits>::PrimitiveType
    max() noexcept
    {
        return outpost::storage::Integer<bits>::maxValue;
    }
