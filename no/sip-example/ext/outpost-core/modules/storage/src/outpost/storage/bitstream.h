/*
 * Copyright (c) 2019-2022, Jan-Gerd Mess
...
#ifndef OUTPOST_STORAGE_BITSTREAM_H_
#define OUTPOST_STORAGE_BITSTREAM_H_

#include <outpost/storage/serializable_object.h>
...
#endif /*OUTPOST_STORAGE_BITSTREAM_H_ */
