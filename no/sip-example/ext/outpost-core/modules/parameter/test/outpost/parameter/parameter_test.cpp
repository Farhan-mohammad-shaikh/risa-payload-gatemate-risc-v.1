...
// This is not a unittest since it will never return or run into an assertion.
// This test is used during development only.
...
//  * \class TestThread
//  */
// class TestThread : public outpost::rtos::Thread
// {
// public:
//     explicit TestThread(int id,
//                         outpost::rtos::Semaphore& waitForReaderAndWriter,
//                         outpost::rtos::Semaphore& startReaderAndWriter) :
//         outpost::rtos::Thread(id),
//         mParameter(nullptr),
//         mId(id),
//         mReportEndOfTestStep(waitForReaderAndWriter),
//         mWaitForStart(startReaderAndWriter)
//     {
//     }
...
//     TestThread&
//     operator=(const TestThread&) = delete;
...
//         {
//             nn++;
//             static bool tryToRead = true;
//             uint8_t last = 0;
//             size_t n = 0U;
//             if (mId == 0)
//             {
//                 mWaitForStart.acquire();
//                 while (tryToRead)
//                 {
//                     n++;
//                     uint8_t value;
//                     auto ret = mParameter->getValue(value);
//                     if (ret != outpost::parameter::OperationResult::success)
//                     {
...
//                 mWaitForStart.acquire();
//                 outpost::time::SpacecraftElapsedTime time;
//                 outpost::rtos::Thread::sleep(outpost::time::Milliseconds(1));
//                 mParameter->setValue(6U, time);
//                 outpost::rtos::Thread::sleep(outpost::time::Milliseconds(1));
//                 tryToRead = false;
//             }
//             mReportEndOfTestStep.release();
//         }
//     }

// public:
//     int mId = 0;
//     outpost::parameter::Parameter<uint8_t>* mParameter;
//     outpost::rtos::Semaphore& mReportEndOfTestStep;
//     outpost::rtos::Semaphore& mWaitForStart;
// };

// TEST(ParameterTest, TEST)
// {
//     outpost::rtos::Semaphore waitForReaderAndWriter(0);
//     outpost::rtos::Semaphore startReaderAndWriter1(0);
//     outpost::rtos::Semaphore startReaderAndWriter2(0);
//     TestThread thd0(0, waitForReaderAndWriter, startReaderAndWriter1);
//     TestThread thd1(1, waitForReaderAndWriter, startReaderAndWriter2);
...
//     while (true)
//     {
//         outpost::parameter::ParameterList list;
//         outpost::time::SpacecraftElapsedTime time;
//         auto* parameter = new outpost::parameter::Parameter<uint8_t>(1, 0, time, list);

//         parameter->setValue(4U, time);
//         parameter->setValue(5U, time);

//         thd0.mParameter = parameter;
//         thd1.mParameter = parameter;

//         startReaderAndWriter1.release();
//         startReaderAndWriter2.release();

//         waitForReaderAndWriter.acquire();
//         waitForReaderAndWriter.acquire();
