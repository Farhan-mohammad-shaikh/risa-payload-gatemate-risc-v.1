...
#ifndef OUTPOST_TRANSPORT_FRAME_ENCODER_HDLC_H
#define OUTPOST_TRANSPORT_FRAME_ENCODER_HDLC_H
...
{
/**
 * Frame encoder/decoder using HDLC byte stuffing
 *
 * The generated output byte stream can be passed directly to the UART
 * interface.
 *
 */
class FrameEncoderHdlc : public FrameEncoder
{
public:
    FrameEncoderHdlc();

    virtual ~FrameEncoderHdlc();

    /**
     * Encode data into the output buffer.
     *
