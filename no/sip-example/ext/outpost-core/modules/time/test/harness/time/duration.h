...
#ifndef HARNESS_TIME_DURATION_H
#define HARNESS_TIME_DURATION_H
...
{
void
PrintTo(outpost::time::Duration duration, std::ostream* os);

void
PrintTo(outpost::time::Microseconds duration, std::ostream* os);

void
PrintTo(outpost::time::Milliseconds duration, std::ostream* os);

void
PrintTo(outpost::time::Seconds duration, std::ostream* os);

void
PrintTo(outpost::time::Minutes duration, std::ostream* os);

void
PrintTo(outpost::time::Hours duration, std::ostream* os);

}  // namespace time
}  // namespace outpost

#endif  // HARNESS_TIME_DURATION_H
