/*
 * Copyright (c) 2019-2023, Jan-Gerd Mess
...
{
void
LeGall53Wavelet::forwardTransform(outpost::Slice<Fixedpoint> inBuffer,
                                  outpost::Slice<Fixedpoint> outBuffer)
{
    ...
    for (step = 0; halfBufferLength > 2; step++)
    {
        ...
        outpost::Slice<Fixedpoint> tmp = inBuffer;
        inBuffer = outBuffer;
        outBuffer = tmp;
    }
...
void
LeGall53Wavelet::forwardTransformInPlace(outpost::Slice<Fixedpoint> inBuffer)
{
    ...
    for (uint16_t step = 0; length >= 3; step++)
    {
        ...
        const Fixedpoint tmpBuffer[3] = {inBuffer[0], inBuffer[1 << step], inBuffer[2 << step]};
...
LeGall53Wavelet::reorder(outpost::Slice<Fixedpoint> inBuffer)
{
                                   ...
                                   outpost::Slice<double> outBuffer)
{
    ...
    {
        size_t halfBufferLength = inBuffer.getNumberOfElements() >> j;
...
const Fixedpoint LeGall53Wavelet::h0 = -0.125;
const Fixedpoint LeGall53Wavelet::h1 = 0.25;
const Fixedpoint LeGall53Wavelet::h2 = 0.75;
const Fixedpoint LeGall53Wavelet::h3 = 0.25;
const Fixedpoint LeGall53Wavelet::h4 = -0.125;

const Fixedpoint LeGall53Wavelet::g0 = -0.5;
const Fixedpoint LeGall53Wavelet::g1 = 1.0;
const Fixedpoint LeGall53Wavelet::g2 = -0.5;

const Fixedpoint LeGall53Wavelet::ip_g0 = 4.0;
const Fixedpoint LeGall53Wavelet::ip_g1 = 0.0;
const Fixedpoint LeGall53Wavelet::ip_g2 = -3.5;
const Fixedpoint LeGall53Wavelet::ip_g3 = -1.0;
const Fixedpoint LeGall53Wavelet::ip_g4 = 0.5;
