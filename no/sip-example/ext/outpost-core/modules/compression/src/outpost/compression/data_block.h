/*
 * Copyright (c) 2020, 2022-2023, Jan-Gerd Mess
...
#ifndef OUTPOST_COMPRESSION_DATA_BLOCK_H_
#define OUTPOST_COMPRESSION_DATA_BLOCK_H_
...
public:
     ...
     * considered complete
     */
    DataBlock(const outpost::container::SharedBufferPointer& p,
    ...
    /**
     * Pushes a single fixedpoint number to the current block if it is valid and not complete yet.
     * @param f Fixedpoint to be pushed to the end of block
    ...
    /**
     * Getter for a Slice of samples (in Fixedpoint format).
...
private:
    ...
    outpost::container::SharedBufferPointer mPointer;
    outpost::Fixedpoint* mSampleBuffer;
