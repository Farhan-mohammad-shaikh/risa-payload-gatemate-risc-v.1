 ...
 * Copyright (c) 2019, 2021, Passenberg, Felix Constantin
                     ...
                     const outpost::time::Duration& timeout)
{
    ...
    if (sendSuccesful)
    {
        ...
        if (options.mReplyMode)
        {
            ...
            {
                const RmapPacket* rply = transaction->getReplyPacket();
...
void
RmapInitiator::handleReplyPacket(const RmapPacket* packet, const outpost::hal::SpWMessage& rx)
{
