...
public:
    using InterruptType = outpost::hal::InterruptType;
...
public:
    ...
    Gpi(const Gpi&) = delete;

    Gpi&
    operator=(const Gpi&) = delete;
...
public:
    ...
    /**
     * Write the value to the pins selected.
     *
     *                                          4   0
     *                                          |   |
     * \c write(value = 0b10000001, mask = 0b00010001)
     *
     * will set pin 4 to \c 0 and pin 0 to \c 1. The rest of the pins will
     * keep there previouse values.
     *
     * \param value
     *      the values for the specific pins
     *
     * \param mask
     *      the pins to write
     *
     ...
     */
    virtual ReturnCode
    write(BankType value, BankType mask = maskAllSet) = 0;
