...
Serial::SerialImpl::reconfigurePort ()
{
  ...
  options.c_lflag &= static_cast<tcflag_t>(~(ICANON | ECHO | ECHOE | ECHOK | ECHONL |
                                       ISIG | IEXTEN)); //|ECHOPRT
  ...
  if (rtscts_)
    ...
    options.c_cflag &= static_cast<unsigned long>( ~(CRTSCTS) );
...
// The FD_* macros trigger old-style-cast warnings
