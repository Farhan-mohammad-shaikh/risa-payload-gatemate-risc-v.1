...
Register Listing for TIMER1
---------------------------

+--------------------------------------------------+-----------------------------------------+
| Register                                         | Address                                 |
+==================================================+=========================================+
| :ref:`TIMER1_LOAD <TIMER1_LOAD>`                 | :ref:`0xf000e000 <TIMER1_LOAD>`         |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_RELOAD <TIMER1_RELOAD>`             | :ref:`0xf000e004 <TIMER1_RELOAD>`       |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_EN <TIMER1_EN>`                     | :ref:`0xf000e008 <TIMER1_EN>`           |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_UPDATE_VALUE <TIMER1_UPDATE_VALUE>` | :ref:`0xf000e00c <TIMER1_UPDATE_VALUE>` |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_VALUE <TIMER1_VALUE>`               | :ref:`0xf000e010 <TIMER1_VALUE>`        |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_EV_STATUS <TIMER1_EV_STATUS>`       | :ref:`0xf000e014 <TIMER1_EV_STATUS>`    |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_EV_PENDING <TIMER1_EV_PENDING>`     | :ref:`0xf000e018 <TIMER1_EV_PENDING>`   |
+--------------------------------------------------+-----------------------------------------+
| :ref:`TIMER1_EV_ENABLE <TIMER1_EV_ENABLE>`       | :ref:`0xf000e01c <TIMER1_EV_ENABLE>`    |
+--------------------------------------------------+-----------------------------------------+
