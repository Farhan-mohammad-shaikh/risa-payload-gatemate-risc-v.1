...
PICOLIBC_DIRECTORY=/home/lucas/Dokumente/litex/pythondata-software-picolibc/pythondata_software_picolibc/data
...
BUILDINC_DIRECTORY=build/colognechip_gatemate_evb/software/include

MYCODEINC_DIRECTORY=code/inc
...
COMMONFLAGS = $(DEPFLAGS) -O0 $(CPUFLAGS) -g3 -no-pie -fomit-frame-pointer -Wall -fno-stack-protector $(INCLUDES)
ifeq ($(LTO), 1)
COMMONFLAGS += -flto
endif
ifneq ($(CPUFAMILY), arm)
...
CXXFLAGS = $(COMMONFLAGS) -std=c++17 -I$(SOC_DIRECTORY)/software/include/basec++ -fno-rtti -ffreestanding
