...
_io = [
    ...
    # Leds
    ("user_led_n", 0, Pins("IO_NA_B0")),
    ("user_led_n", 1, Pins("IO_NA_B1")),
    ("user_led_n", 2, Pins("IO_NA_A0")),
    ("user_led_n", 3, Pins("IO_NA_A1")),
    ...
    ("spi_flash", 0,
        ...
        Subsignal("miso", Pins("IO_WA_A7")),
        Subsignal("mosi", Pins("IO_WA_B7")),
    ...
    #),
     ...
     # HyperRAM
    ("hyperram", 0,
        Subsignal("dq", Pins("IO_EB_A3 IO_EB_A6 IO_EB_A4 IO_EB_B4 IO_EB_B0 IO_EB_A1 IO_EB_B6 IO_EB_B8")),
        Subsignal("rwds", Pins("IO_EB_B2")),
        Subsignal("cs_n", Pins("IO_EB_A2")),
        Subsignal("rst_n", Pins("IO_EB_A0")),
        Subsignal("clk_p", Pins("IO_EB_A5")),
        Subsignal("clk_n", Pins("IO_EB_B5")),
    ),

    # Uart
    ("uart_logging", 0,
        Subsignal("tx", Pins("IO_NA_A7")),
        Subsignal("rx", Pins("IO_NA_B7")),
    ),

    ("uart_obc", 0,
        Subsignal("tx", Pins("IO_NA_B4")),
        Subsignal("rx", Pins("IO_NA_A4")),
    ),

    ("uart_ice40", 0,
        Subsignal("tx", Pins("IO_SA_A0")),
        Subsignal("rx", Pins("IO_SA_B0")),
    ),

    # I2C
    ("i2c1", 0,
        Subsignal("scl", Pins("IO_WB_A7")),
        Subsignal("sda", Pins("IO_WB_B7")),
    ),
    ("i2c0", 0,
        Subsignal("scl", Pins("IO_WB_A5")),
        Subsignal("sda", Pins("IO_WB_B5")),
    ),

    # ICE40 Voltage Control
    ("power_fauld_ice40", 0, Pins("IO_WB_A2")),
    ("core_en_ice40", 0, Pins("IO_WB_A3")),
    ("vio_en_ice40", 0, Pins("IO_WB_B3")),
    ("osc_en_ice40", 0, Pins("IO_EA_A3")),

    # ICE40_VIO - GateMate IO EAST Interface
    ("ice40_io_vio_0", 0, Pins("IO_EA_B5")),
    ("ice40_io_vio_1", 0, Pins("IO_EA_B0")),
    ("ice40_io_vio_2", 0, Pins("IO_EA_A0")),
    ("ice40_io_vio_3", 0, Pins("IO_EA_A1")),
    ("ice40_io_vio_4", 0, Pins("IO_EA_A2")),
    ("ice40_io_vio_5", 0, Pins("IO_EA_B2")),

    # ICE40_VCORE - GateMate IO SOUTH Interface
    ("ice40_io_vcore_0", 0, Pins("IO_SA_B3")),
    ("ice40_io_vcore_1", 0, Pins("IO_SA_A3")),
    ("ice40_io_vcore_2", 0, Pins("IO_SA_B5")),
    #("ice40_io_vcore_3", 0, Pins("IO_SA_B0")),
    ("ice40_io_vcore_4", 0, Pins("IO_SA_A5")),
    #("ice40_io_vcore_5", 0, Pins("IO_SA_A0")),

    # ICE40 Programming Interface
    ("spi_ice40", 0,
        Subsignal("clk",    Pins("IO_EA_B7")),
        Subsignal("cs_n",   Pins("IO_EA_B4")),
        Subsignal("mosi",   Pins("IO_EA_A4")),
        Subsignal("miso",   Pins("IO_EA_A5")),
    ),
    ("creset_ice40", 0, Pins("IO_EA_A7")),
    ("cdone_ice40", 0, Pins("IO_EA_A8")),

    # Debugs
    ("gatemate_debug_4", 0, Pins("IO_NB_A2")),
    ("gatemate_debug_5", 1, Pins("IO_NB_B2")),
    ("gatemate_debug_3", 2, Pins("IO_NB_B3")),
]
...
def usb_pmod_io(pmod):
    return [
        ...
        ("usb_uart", 0,
            Subsignal("tx", Pins(f"{pmod}:0")),
            Subsignal("rx", Pins(f"{pmod}:1")),
        ),
    ]
